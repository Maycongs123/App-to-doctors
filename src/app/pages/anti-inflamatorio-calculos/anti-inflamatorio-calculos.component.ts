...
export class AntiInflamatorioCalculosComponent {
  ...
  constructor(private route: ActivatedRoute){
    ...
    receberDados(dados: any) {
      let nomeDados = dados;
      this.dadosAntiInflamatorio = this.getMedicamentoByName(nomeDados);
    }
  
    getMedicamentoByName(nomeAntiInflamatorio: any){
      let dadosFiltrados;
      dadosFiltrados =  this.listaAntiInflamatorio.find((medicacao: any) => medicacao.nome === nomeAntiInflamatorio);
      return dadosFiltrados;
    }
  
  listaAntiInflamatorio: any = [
    {
      id: 1,
      nome: "Amicacina",
