...
export class HidratacaoVenosaCalculosComponent {
  ...
  constructor(private route: ActivatedRoute){
    ...
    receberDados(dados: any) {
      let nomeDados = dados;
      this.dadosHidratacaoVenosa = this.getMedicamentoByName(nomeDados);
    }
  
    getMedicamentoByName(nomeHidratacaoVenosa: any){
      let dadosFiltrados;
      dadosFiltrados =  this.listaHidratacaoVenosa.find((medicacao: any) => medicacao.nome === nomeHidratacaoVenosa);
      return dadosFiltrados;
    }
  
  listaHidratacaoVenosa: any = [
    {
      id: 1,
      nome: "Amicacina",
