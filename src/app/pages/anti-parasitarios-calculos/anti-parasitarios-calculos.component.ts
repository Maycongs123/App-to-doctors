...
export class AntiParasitariosCalculosComponent {
  ...
  constructor(private route: ActivatedRoute){
    ...
    receberDados(dados: any) {
      let nomeDados = dados;
      this.dadosAntiParasitarios = this.getMedicamentoByName(nomeDados);
    }
  
    getMedicamentoByName(nomeAntiParasitarios: any){
      let dadosFiltrados;
      dadosFiltrados =  this.listaAntiParasitarios.find((medicacao: any) => medicacao.nome === nomeAntiParasitarios);
      return dadosFiltrados;
    }
  
  listaAntiParasitarios: any = [
    {
      id: 1,
      nome: "Amicacina",
      tipo: "Anti-Parasitários",
      aplicacao: "IM/V",    
      indicacoesClinicas:[
        {
          indicacao: "Crianças",
