...
export class BroncodilatadoresCalculosComponent {
  ...
  constructor(private route: ActivatedRoute){
    ...
    receberDados(dados: any) {
      let nomeDados = dados;
      this.dadosBroncodilatadores = this.getMedicamentoByName(nomeDados);
    }
  
    getMedicamentoByName(nomeBroncodilatadores: any){
      let dadosFiltrados;
      dadosFiltrados =  this.listaBroncodilatadores.find((medicacao: any) => medicacao.nome === nomeBroncodilatadores);
      return dadosFiltrados;
    }
  
  listaBroncodilatadores: any = [
    {
      id: 1,
      nome: "Amicacina",
