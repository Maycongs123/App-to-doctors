...
export class AdministradorComponent {
  ...
  formMedicacao(result: any) {   
    ...
    const formMedicamento = this.formBuilder.group({
      ...
      alteracaoValorFaixas: result.alteracaoValorFaixas,
      dosagemMaxima: result.dosagemMaxima,
      variacaoMinimaDosagemMaxima: result.variacaoMinimaDosagemMaxima,
      variacaoMaximaDosagemMaxima: result.variacaoMaximaDosagemMaxima,
      valor_1_ClearanceCreatinina: result.valor_1_ClearanceCreatinina ,
      valor_2_ClearanceCreatinina: result.valor_2_ClearanceCreatinina,
      valor_3_ClearanceCreatinina: result.valor_3_ClearanceCreatinina,
      valor_1_Porcetagem_ClearanceCreatinina: result.valor_1_Porcetagem_ClearanceCreatinina,
      valor_2_Porcetagem_ClearanceCreatinina: result.valor_2_Porcetagem_ClearanceCreatinina,
      valor_3_Porcetagem_ClearanceCreatinina: result.valor_3_Porcetagem_ClearanceCreatinina,
      faixa_1_HorarioClCr: result.faixa_1_HorarioClCr ,
      faixa_2_HorarioClCr: result.faixa_2_HorarioClCr,
      faixa_Hemodialise_Horario: result.faixa_Hemodialise_Horario ,
