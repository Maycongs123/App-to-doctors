...
export class AntiHistaminicosCalculosComponent {
  ...
  constructor(private route: ActivatedRoute){
    ...
    receberDados(dados: any) {
      let nomeDados = dados;
      this.dadosAntiHistaminicos = this.getMedicamentoByName(nomeDados);
    }
  
    getMedicamentoByName(nomeAntiHistaminicos: any){
      let dadosFiltrados;
      dadosFiltrados =  this.listaAntiHistaminicos.find((medicacao: any) => medicacao.nome === nomeAntiHistaminicos);
      return dadosFiltrados;
    }
  
  listaAntiHistaminicos: any = [
    {
      id: 1,
      nome: "Amicacina",
